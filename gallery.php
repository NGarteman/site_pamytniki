...
<body>
    <nav class="z-depth-5">
      ...
      <div class="back-btn"  style="margin-top: 50px; margin-left: 30px; position: absolute;"><a href="index.php" class="tooltipped" data-position="bottom" data-tooltip="Вернуться на главную"><i style="color: #ecf0f1!important;" class="fas fa-arrow-left fa-3x"></i></a></div>
      <h1 class="carousel-h1 center-align">Памятники</h1>
      <div class="img1"></div>
